...
industries_cities <- subset(topcities, indust %in% c("11", "55", "12","71", "50", "6", "74", "100","104"))

industries_cities <- industries_cities[!is.na(industries_cities$gdp),]

#p <- qplot(x= year,y= gdp, data= industries_cities, colour = indust, geom="line", facets=~ fips)
