...
fileNames <- c("2003/03mfips.txt", "2003-12/0312mfips.txt", "2004/List1.txt", "2005/List1.txt", "2006/List1.txt", "2007/List1.txt")
...
get_txt <- function(name) {
  download.file(
    paste("http://www.census.gov/population/www/metroareas/lists/", name, sep = ""),
    paste("original/", strsplit(name, "/")[[1]][1], ".txt", sep = "", collapse = "")
  )
}
