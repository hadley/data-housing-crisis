...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Here "mybibfile" refers to the file "mybibfile.bib" in the local directory.
% Replace "mybibfile" with the name of your bibliography file.

\bibliography{connexionsbib}
